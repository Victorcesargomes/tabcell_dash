...
df = pd.read_csv("tabcell_lojas.csv", sep=",")
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row(
                        dbc.Col(
                            html.Legend("Faturamento Total em 12/2023(somatório de faturamento das lojas)", className="text-center")
                        )
                    ),
                    dbc.Row([
                        dbc.Col([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row(
                        dbc.Col(
                            html.Legend("Custo Total em 12/2023(somatório do custo em cada loja)", className="text-center")
                        )
                    ),
                    dbc.Row([
                        dbc.Col([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row(
                        dbc.Col(
                            html.Legend("Faturamento total por dia em 12/2023 (faturamento de todas as lojas)", className="text-center")
                        )
                    ),
                    dbc.Row([
                        dbc.Col([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardBody([
                    dbc.Row(
                        dbc.Col(
                            html.Legend("Lucro total por Dia em 12/2023", className="text-center")
                        )
                    ),
                    dbc.Row([
                        dbc.Col([
...
contador_layout = dbc.Row([
    dbc.Col([
        ...
        html.H3("1. Qual loja apresenta o melhor desempenho em 12/2023?", style={'margin-bottom': '5px'}),
        html.H5("R. Dentre as três lojas, a Loja 1 apresenta o melhor desempenho em termos de faturamento e lucro. Por exemplo, o faturamento da Loja 1 em 12/2023 foi de R$ 10.769,00 e lucro de R$ 8.096,00. Em termos de comparação, a Loja 1 superou o lucro da Loja 3 em 28%. Ou seja Loja 1 foi 15% mais rentável do que a Loja 3.", 
                style={'margin-bottom': '30px'}),
        
        html.Br(),
        html.H3("2. Qual loja teve o menor custo em 12/2023?", style={'margin-bottom': '5px'}),
        html.H5("R. A Loja 3 teve o menor custo em 12/2023: R$ 598,00. Esse dado é muito relevante pois demonstra que a Loja 3 foi mais eficiente em termos de faturamento e custo do que as outras lojas", 
                style={'margin-bottom': '30px'}),
        
        html.Br(),
        html.H3("3. Comparação Loja 2 e Loja 3!", style={'margin-bottom': '5px'}),
        html.H5("R. A Loja 2, quando comparada com a Loja 3, apresentou um faturamento de R$ 9.012. Em termos percentuais, a Loja 2 faturou 29% a mais do que a Loja 3. Esse dado é interessante pois existe uma particularidade entre essas duas lojas: ambas estão localizadas na Galeria 910. Nesse caso, é de suma importância acompanhar a evolução de faturamento das lojas ao longo do tempo e verificar se essa diferença de faturamento continua.", 
                style={'margin-bottom': '30px'}),
